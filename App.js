...
/**Make sure to link up your html files here, so you can see your work**/
app.get('/general_frames/venue_guidelines', function (req, res) {
    res.sendFile(publicPath + '/general_frames/');
});
app.get('/general_frames/', function (req, res) {
    res.sendFile(publicPath + '/general_frames/venue_guidelines/venueGuidelines.html');
});
app.get('/tasks/task1_homepage/', function (req, res) {
    res.sendFile(publicPath + '/task1_homepage/homepage.html');
});
app.get('/tasks/task2_report/', function (req, res) {
    res.sendFile(publicPath + '/task2_report/report.html');
});
app.get('/tasks/task3_comments/', function (req, res) {
    res.sendFile(publicPath + '/task3_comments/comments.html');
});
